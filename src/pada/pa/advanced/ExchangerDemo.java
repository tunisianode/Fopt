...
class ExchangeThread extends Thread
{
    ...
    public ExchangeThread(String name, int s, int n, Exchanger<Integer> e)
    {
        super(name);
        this.startValue = s;
...
public class ExchangerDemo
{
    public static void main(String[] args)
    {
        ...
        ExchangeThread t1 = new ExchangeThread("T1", 101, 2, exchanger);
        ExchangeThread t2 = new ExchangeThread("T2", 201, 2, exchanger);
        t1.start();
        t2.start();
    }
}